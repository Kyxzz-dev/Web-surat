                ...
                <div class="col-sm-5 text-center text-sm-left">
                    <div class="card-body pb-0 px-0 px-md-4">
                        <img src="{{ asset('sneat/img/man-with-laptop-light.png') }}" height="140"
                             alt="Dashboard Image" data-app-dark-img="illustrations/man-with-laptop-dark.png"
            ...
            <div class="card">
                <div class="card-body">
                    <div class="d-flex justify-content-between flex-sm-row flex-column gap-3">
                        <div>
                            <h5 class="mb-2">{{ __('dashboard.today_graphic') }}</h5>
                        ...
                        <div id="profileReportChart" style="min-height: 150px; width: 100%;">
