<div class="card">
    <div class="card-body">
        <div class="card-title d-flex align-items-start justify-content-between">
          ...
          @if(!(auth()->user()->role == 'staff' && $label == __('dashboard.incoming_letter')) 
    && !(auth()->user()->role == 'staff' && $label == __('dashboard.active_user')))
    <div class="dropdown">
        ...
        <div class="dropdown-menu dropdown-menu-end" aria-labelledby="cardOpt3">
            @if($label == __('dashboard.incoming_letter') && auth()->user()->role != 'staff')
