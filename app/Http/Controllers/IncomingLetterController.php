    ...
    public function create(): View
{
    ...
    $reference_number = ''; // atau $this->generateReferenceNumber($default_code, $today);
    ...
    public function store(StoreLetterRequest $request): RedirectResponse
    {
        try {
            ...
            $classification = \App\Models\Classification::findOrFail($request->classification_id);
            $newLetter['classification_code'] = $classification->code; // ← penting ditambahkan

            //$ref = ltrim($newLetter['reference_number'], 'WIM.2-'); // hapus jika user ngetik manual
            //$newLetter['reference_number'] = 'WIM.2-' . $ref;
